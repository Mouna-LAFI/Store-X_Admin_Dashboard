...
<body>
            ...
            <div class="main-content">
			 <div align="right">
                                    <button class="au-btn au-btn-icon au-btn--blue" onclick="window.location='add_admins.php'">

                                        <i class="zmdi zmdi-plus"></i>Ajouter un admin</button> </div>
...
while($donnees = mysqli_fetch_array($result))  
{
 ?>
   ...
   <td><?php echo $donnees['motdepasse'];?></td>
	...
	<td>
<a href="edit_admins.php?id=<?php echo $donnees['id'];?>" onclick="return confirm('Voulez-vous modifier cet utilisateur ?');"> 
<i class="far fa-edit"style="color:green"></i></a>
<a href="supprimer_admins.php?id=<?php echo $donnees['id'];?>" onclick="return confirm('Voulez-vous supprimer cet utilisateur ?');"> 
